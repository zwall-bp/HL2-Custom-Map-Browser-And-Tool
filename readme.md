...
Using the power of Source's [Bonus Map](https://developer.valvesoftware.com/wiki/Bonus_Maps) feature, we can use it as a stylish in-game browser.
...
This allows for a much cleaner and modular experience on the end user's side.
...
With the power of the Source Engine's `custom/` directory for overwriting and adding assets, we can break down each map into their own folder to allow for easy installation and deletion of all of the assets for a single map.
...
1. Copy the given folder content into `[Steam Directory]/common/Half-Life 2/ep2/custom/`
...
* **--map:** To give a directory to a `.bsp` file.
...
* **--json:** Instead output or add onto a json file with the data of this map. Used for creating map packs.
...
> **Example:** -j "./the-cool-map-pack.json"
...
> **Example:** -i "~/Desktop/Screenshots/my-map-screenshot.png"
